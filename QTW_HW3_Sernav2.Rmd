...
IsSpamFold1 = rep(c(TRUE, FALSE), c(length(wordFoldTestIndexes1)))
IsSpamFold2 = rep(c(TRUE, FALSE), c(length(wordFoldTestIndexes2)))
IsSpamFold3 = rep(c(TRUE, FALSE), c(length(wordFoldTestIndexes3)))
IsSpamFold4 = rep(c(TRUE, FALSE), c(length(wordFoldTestIndexes4)))
IsSpamFold5 = rep(c(TRUE, FALSE), c(length(wordFoldTestIndexes5)))
